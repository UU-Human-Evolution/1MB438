...
This is the last session of the bioinformatics project (and of the course). You will wrap up the project today and present your results to the class on the next session. This 4-hour session will be used to prepare the presentation.

## Goals

  + Further your understanding of your results
  + Plot trees with a visualization software
  + Answer the question you were given in Lab 1
